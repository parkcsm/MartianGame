...
public class rhombus {
	public static void main(String[] args) {
		int revisedlength =5;
		int length = 2*revisedlength;                               // Characteristic of Array : First Declaration is different from definition ex) new String[length][length] 
		...
		for(int x= 0;  x < length; x++){
			for(int y= 0;  y < length; y++){
				if( 
						 ...
						 y<x+DoubleCalculator/2 && y> x-DoubleCalculator/2 && y<-x + 1.5*DoubleCalculator && y> -x + DoubleCalculator/2					
