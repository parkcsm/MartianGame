...
public class Circle {
	...
	public static void main(String[] args) {
		int revisedlength =5;
		int length = revisedlength+7;                               // Characteristic of Array : First Declaration is different from definition ex) new String[length][length] 
		...
		for(int x= 0;  x < length; x++){
			for(int y= 0;  y < length; y++){
				if( 
						 ...
						 Math.pow(x-Math.floor(DoubleCalculator/2), 2) + Math.pow(y-Math.floor(DoubleCalculator/2), 2) < Math.pow(Math.floor(DoubleCalculator/2), 2) 						
...
// ((y<= f*f*f*f*f*h*f*f*f*h*h*b*b*g*(x+42*z)-p*e*e*e*e*p*DoubleCalculator-0*z) && (y<= -f*h*h*h*f*f*h*h*h*h*h*h*b*p*p*(x+22*z) + f*b*p*p*DoubleCalculator+4*z)) 
//&&      ((y>= -f*d*p*h*h*p*p*h*h*h*h*h*h*x  + DoubleCalculator*a*f*f*h*h*h*h*h*h*h*h*h*h*h*p*p*p+15*z) ||  (y >= f*f*d*f*f*g*g*g*(x+5*z)  + f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*h*h*h*h*h*h*h*h*h*h*h*h*h*h*h*h*h*h*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*DoubleCalculator+15*z))
//||					( (y<= d*p*p*DoubleCalculator+11*z && y>= d*p*p*DoubleCalculator-5*z)  &&   (y>= -f*f*f*d*p*p*p*p*p*p*p*p*p*p*p*(x+75*z) + DoubleCalculator*a*p*f*f*h*h*h*h*h*h*h*h*h*h*h*p*p*p+70*z) ) &&   (y >= f*d*p*p*(x+5*z) + h*h*h*h*h*h*h*h*h*h*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*DoubleCalculator+15*z))
//
//) 
//
//
//&& 		 ((y>= -h*h*h*f*f*f*f*f*f*d*p*h*h*p*p*h*h*h*h*h*h*(x+3*z)  + DoubleCalculator*a*f*f*h*h*h*h*h*h*h*h*h*h*h*p*p*p+9*z) ||  (y >= f*h*h*h*h*h*h*h*h*f*f*h*h*f*f*f*f*f*d*f*f*g*g*g*(x-5*z)  + f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*h*h*h*h*h*h*h*h*h*h*h*h*h*h*h*h*h*h*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*f*DoubleCalculator+5*z))
//
//) && ((y>e1*(x-82*z)+ 57*z) || (y>-e2*(x-79*z)+ 45*z) )